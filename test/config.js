/* =====================================================================
   TEST BUILD - DO NOT USE FOR ANYTHING REAL
   Points at the TEST Supabase project (dkqubldmfyeuudecxmvh) and, through
   it, the TEST Airtable base (appQktredAuGa1X7e). All data is synthetic.
   The live Hub at the repository root is untouched and still points at
...
window.APP_CONFIG = {
supabaseUrl: "https://dkqubldmfyeuudecxmvh.supabase.co",
supabasePublishableKey: "sb_publishable_9B7toOyeF43OyWSiGMz7_g_kv28MsnC",
   
  contentApiUrl: "https://dkqubldmfyeuudecxmvh.supabase.co/functions/v1/hub-content",
